            ...
            <div className="relative">
              <button 
                ...
                className={clsx(
                  ...
                  showNotifications ? "text-rihla bg-rihla/8" : "text-slate-500 hover:text-rihla hover:bg-slate-100 dark:hover:bg-white/10"
                )}
              >
                <Bell size={16} strokeWidth={1.75} />
                {unreadCount > 0 && (
                  <span className="absolute top-1.5 right-1.5 w-1.5 h-1.5 bg-rihla rounded-full" />
                )}
              </button>
              ...
              <AnimatePresence>
                {showNotifications && (
                  ...
                  >
                    <NotificationHub onClose={() => setShowNotifications(false)} />
                  </motion.div>
                )}
              </AnimatePresence>
            </div>
