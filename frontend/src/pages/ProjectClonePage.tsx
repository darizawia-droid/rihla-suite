      ...
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-8">
        <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-white/10 p-12 max-w-md text-center shadow-xl">
          ...
          <div className="flex gap-3">
            ...
            <button className="flex-1 px-6 py-3 bg-rihla text-white rounded-2xl text-xs font-black uppercase shadow-lg shadow-rihla/20 hover:bg-rihla/90 transition-all">
              Ouvrir le projet
            </button>
          </div>
        </div>
