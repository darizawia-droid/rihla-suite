    ...
    <div className="min-h-screen" style={{ background: 'linear-gradient(160deg,#fdf7de 0%,#f5efe0 100%)' }}>
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              <span className="text-amber-400/80 text-[10px] font-bold uppercase tracking-[0.3em]">S'TOURS DMC · Outil Interne v2.2</span>
            </div>
          ...
          <div className="flex items-center gap-4">
            <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-xl px-4 py-2 flex items-center gap-2 group cursor-pointer">
              <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
              <span className="text-emerald-400 text-[10px] font-black uppercase tracking-widest">Forex Hedge ON (2.5%)</span>
            </div>
      ...
      <div className="max-w-7xl mx-auto p-8 space-y-6">
        ...
        <div className="bg-slate-900 rounded-[32px] p-8 shadow-2xl border border-white/5 relative overflow-hidden group">
          <div className="absolute top-0 right-0 w-64 h-64 bg-rihla/10 rounded-full -mr-32 -mt-32 blur-3xl group-hover:bg-rihla/20 transition-all" />
          <div className="flex items-start justify-between mb-8">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-rihla rounded-2xl flex items-center justify-center text-white shadow-xl shadow-rihla/20">
                <Brain size={24} />
              </div>
              <div>
                <h3 className="text-lg font-black text-white tracking-tight">AI Budget Intelligence</h3>
                <p className="text-white/40 text-[11px] font-bold uppercase tracking-widest mt-1 italic">Analyse stratégique de rentabilité en temps réel</p>
              </div>
            </div>
            <div className="flex gap-2">
              <span className="px-3 py-1 bg-emerald-500/20 text-emerald-400 rounded-full text-[9px] font-black uppercase tracking-widest border border-emerald-500/20">Optimal</span>
              <span className="px-3 py-1 bg-amber-500/20 text-amber-400 rounded-full text-[9px] font-black uppercase tracking-widest border border-amber-500/20">Risque FX Bas</span>
            </div>
          </div>

          <div className="grid grid-cols-3 gap-6">
            <div className="bg-white/5 border border-white/5 p-5 rounded-2xl">
               <h4 className="text-[10px] font-black text-white/40 uppercase mb-3 flex items-center gap-2"><Info size={12} className="text-rihla" /> Profil de Coût</h4>
               <p className="text-xs text-white/80 leading-relaxed font-medium">L'hébergement représente **62%** du budget total. L'autocar (bus) est optimisé à **8.5 MAD/km**, soit le meilleur tarif du marché.</p>
            </div>
            <div className="bg-white/5 border border-white/5 p-5 rounded-2xl">
               <h4 className="text-[10px] font-black text-white/40 uppercase mb-3 flex items-center gap-2"><Sparkles size={12} className="text-emerald-400" /> Opportunités</h4>
               <p className="text-xs text-white/80 leading-relaxed font-medium">Un switch d'hôtel à **Day 4** permettrait de gagner **120 MAD/pax** tout en améliorant la note fournisseur de **4.2** à **4.7**.</p>
            </div>
            <div className="bg-white/5 border border-white/5 p-5 rounded-2xl">
               <h4 className="text-[10px] font-black text-white/40 uppercase mb-3 flex items-center gap-2"><Calculator size={12} className="text-amber-400" /> Sensibilité FX</h4>
               <p className="text-xs text-white/80 leading-relaxed font-medium">Le point mort est à **1 USD = 9.20 MAD**. Nous recommandons un hedge de **2.5%** pour sécuriser la marge DMC.</p>
            </div>
          </div>
        </div>
