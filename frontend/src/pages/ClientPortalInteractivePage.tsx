...
export function ClientPortalInteractivePage() {
  ...
  const handleSign = () => {
    const hash = 'SHA256:' + Math.random().toString(36).substring(2, 15).toUpperCase()
    setConsentHash(hash)
    setStatus('signed')
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors">
      ...
      <div className="max-w-6xl mx-auto p-8 grid grid-cols-12 gap-8">
        ...
        <div className="col-span-8 space-y-6">
          ...
          {/* Interactive Map */}
          <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-white/10 overflow-hidden shadow-sm relative group">
              ...
              <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-500/20 rounded-2xl p-6 text-center">
                ...
                {consentHash && (
                  <div className="mt-4 pt-4 border-t border-emerald-200 dark:border-emerald-500/20">
                    <p className="text-[8px] font-black text-emerald-600/40 uppercase tracking-widest mb-1">Preuve de Consentement Numérique</p>
                    <code className="text-[10px] font-mono text-emerald-600 bg-white dark:bg-black/20 px-2 py-1 rounded">{consentHash}</code>
                  </div>
                )}
              </div>
            )}
