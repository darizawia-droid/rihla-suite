      ...
      <main className="max-w-[1600px] mx-auto px-8 py-8">
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-4 space-y-8">
            ...
            {/* Drivers Live Map Preview */}
            <div className="bg-[#111827] rounded-[40px] border border-white/5 shadow-2xl h-[400px] relative overflow-hidden group">
               <div className="absolute top-0 left-0 right-0 p-4 z-10 flex justify-between items-center pointer-events-none">
                  <h3 className="font-black text-white text-[10px] uppercase tracking-widest flex items-center gap-2 bg-black/50 px-3 py-1.5 rounded-full backdrop-blur-md">
                    <Navigation size={14} className="text-cyan-400" /> Live Fleet Tracking
                  </h3>
                  <span className="text-[8px] font-black text-cyan-400 bg-cyan-400/20 px-2 py-0.5 rounded-full backdrop-blur-md">BETA</span>
               </div>
               <div className="h-full w-full">
                 <GroupItineraryMap />
               </div>
               <div className="absolute bottom-4 right-4 z-10 p-2 bg-black/50 backdrop-blur-md rounded-xl border border-white/10 pointer-events-none">
                 <p className="text-[9px] font-bold text-slate-300">Synchronisé · Live GPS</p>
               </div>
            </div>
