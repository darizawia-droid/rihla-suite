...
class StaffSummary(BaseModel):
    ...
    email: Optional[str]
    role_name: Optional[str] = None # To be populated manually or via relationship
...
class ProjectResponse(BaseResponse):
    ...
    assigned_guide: Optional[StaffSummary] = None
    assigned_driver: Optional[StaffSummary] = None
